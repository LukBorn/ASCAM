...
filepaths = {
    'EDTA1': ("EDTA1.171025 019.apkl_first_events.csv",
              47,
              fig.add_subplot(gs[0, 0]),
              [0.  , -0.57, -1.18, -1.75, -2.33],
              'EDTA+CTZ'),
    'EDTA2': ("EDTA2.180125 024._first_events.csv",
              None,
              fig.add_subplot(gs[0, 1]),
              [0.  , -0.5 , -1.04, -1.54, -2.05],
              'EDTA+CTZ'),
    'EDTA3': ("EDTA3.180518 004.apkl_first_events.csv",
              list(range(344))+list(range(466,486)),
              fig.add_subplot(gs[0, 2]),
              [0.  , -0.53, -1.1 , -1.63, -2.17],
              'EDTA+CTZ'),
    'Zn1': ("Zn1.180124 024._first_events.csv",
            None,
            fig.add_subplot(gs[1, 0]),
            [0.  , -0.57, -1.18, -1.75, -2.33],
            'Zn+CTZ'),
    "Zn2": ("Zn2.180426 000._first_events.csv",
            None,
            fig.add_subplot(gs[1, 1 ]),
            [0.  , -0.57, -1.18, -1.75, -2.33],
            'Zn+CTZ'),
    'Zn3': ("Zn3.180507 014._first_events.csv",
            None,
